...
var Battle = new Phaser.Class({
    ...
    update: function (time, delta) {
     ...
     // console.log('tttt', this.Things, this)
      ...
      this.skirmishBattleHUD1.setText(`
        PLAYER 1
          ${this.Things['PLAYER_1'].G.health} Health
          ${this.Things['PLAYER_1'].G.energy} Energy
      `);

      this.skirmishBattleHUD2.setText(`
        PLAYER 2
          ${this.Things['PLAYER_2'].G.health} Health
          ${this.Things['PLAYER_2'].G.energy} Energy
      `);
